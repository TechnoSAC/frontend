        ...
        <nav class="side-nav">
          ...
          <div class="side-group">
            ...
            <div v-if="fulfillmentExpanded" class="sub-nav">
              <router-link to="/fulfillment/vehicles" class="sub-item">{{ t('fulfillment.vehicles') }}</router-link>
              <router-link to="/fulfillment/drivers" class="sub-item active-sub">{{ t('fulfillment.drivers') }}</router-link>
            </div>
          </div>
          <a class="side-item">
