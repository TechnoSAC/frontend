        ...
        <nav class="side-nav">
          ...
          <div class="side-group">
            ...
            <div v-if="reportsExpanded" class="sub-nav">
              <router-link to="/reporting/supplier" class="sub-item">{{ t('reporting.supplier-dashboard') }}</router-link>
              <router-link to="/reporting/portfolio" class="sub-item active-sub">{{ t('reporting.client-portfolio') }}</router-link>
            </div>
          </div>
        </nav>
      </aside>
